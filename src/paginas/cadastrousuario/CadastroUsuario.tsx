...
function CadastrarUsuario() {
  ...
  async function cadastrar(e: ChangeEvent<HTMLFormElement>){
    ...
    if(confirmarSenha == user.senha){
      //confirmarSenha === user.senha && user.senha.length>= 8
      try {
    ...
    <Grid container direction='row' justifyContent='center' alignItems='center'>
      ...
      <Box padding={10}>
        <form onSubmit={cadastrar}>
          ...
          <TextField value={user.ConfirmarSenha} onChange={(e: ChangeEvent<HTMLInputElement>) => confirmarSenhaHandle(e)} id='confirmarSenha' label='ConfirmarSenha' variant='outlined' name='confirmarSenha' margin='normal' type='password' fullWidth placeholder='insira novamente a senha '  />
